    ...
    <body>
            <div>
                <div class="contenedorAcceder">
                    <span data-toggle="modal"><button id="agregarArticulo" class="btn acceder cd-signin" data-toggle="tooltip" title="Agregar Articulo" data-placement="left"> <i class="fa fa-plus"></i></button></span>
                </div>
            </div>
            <header>
